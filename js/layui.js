        ...
        w = {
            ...
            tabDelete: function(t, i) {
                ...
                !1 !== layui.event.call(i[0], r, "tabBeforeDelete(" + n + ")", {
                    ...
                    index: a + 1
                }) : i.prev()[0] && i.prev().is("li") && w.tabClick.call(i.prev()[0], null, a - 1)), i.remove(), (s ? i = (i = l.filter('[lay-id="' + s + '"]')).length ? i : l.eq(a) : l.eq(a)).remove(), setTimeout(function() {
                    w.tabAuto()
                    ...
                    select: function(e) {
                        var p = "\u8bf7\u9009\u62e9",
                            ...
                            y = function(n, e, t, i, u, a) {
                                var l, d, r, s, o, c, h, p, f, y = T(this),
                                    v = e,
                                    m = v.find("input"),
                                    g = n.find("dl"),
    ...
    var p = layui.$,
        ...
        c = (n.prototype.config = {
            ...
            y && (r.layBox.addClass(I), "radio" === i.type) || (u && (a = {}, layui.each(i.index, function(e, t) {
                ...
                return i.index[e]
            } : '[data-index="' + i.index + '"]'), i = p.extend({
                type: "checkbox"
            }, i), l = x.cache[r.key], t = "checked" in i, n = function(e) {
